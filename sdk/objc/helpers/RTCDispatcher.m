...
+ (void)initialize {
  ...
  dispatch_once(&onceToken, ^{
    kAudioSessionQueue = dispatch_queue_create(
        "org.webrtc.cachy.RTCDispatcherAudioSession",
        DISPATCH_QUEUE_SERIAL);
    kCaptureSessionQueue = dispatch_queue_create(
        "org.webrtc.cachy.RTCDispatcherCaptureSession",
        DISPATCH_QUEUE_SERIAL);
    kNetworkMonitorQueue =
        dispatch_queue_create("org.webrtc.cachy.RTCDispatcherNetworkMonitor", DISPATCH_QUEUE_SERIAL);
  });
}
