...
import org.webrtc.cachy.EncodedImage;
import org.webrtc.cachy.EncodedImage.FrameType;
import org.webrtc.cachy.FakeMediaCodecWrapper.State;
import org.webrtc.cachy.VideoCodecStatus;
import org.webrtc.cachy.VideoEncoder;
import org.webrtc.cachy.VideoEncoder.CodecSpecificInfo;
import org.webrtc.cachy.VideoEncoder.EncodeInfo;
import org.webrtc.cachy.VideoEncoder.Settings;
import org.webrtc.cachy.VideoFrame;
import org.webrtc.cachy.VideoFrame.Buffer;
import org.webrtc.cachy.VideoFrame.I420Buffer;
  ...
  private class TestEncoderBuilder {
    ...
    public TestEncoder build() {
      return new TestEncoder((String name)
          ...
          "org.webrtc.cachy.testencoder", codecType,
