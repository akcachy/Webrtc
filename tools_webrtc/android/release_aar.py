...
AAR_PROJECT_DEPENDENCY = "implementation 'org.webrtc.cachy:google-webrtc:1.0.+'"
AAR_PROJECT_VERSION_DEPENDENCY = "implementation 'org.webrtc.cachy:google-webrtc:%s'"
